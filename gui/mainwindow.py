...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.gridLayout.addWidget(self.checkboxes[0], 2, 0, 1, 1)
        self.gridLayout.addWidget(self.checkboxes[1], 2, 1, 1, 1)
        self.gridLayout.addWidget(self.checkboxes[2], 2, 2, 1, 1)
        self.gridLayout.addWidget(self.checkboxes[3], 3, 0, 1, 1)
        self.gridLayout.addWidget(self.checkboxes[4], 3, 1, 1, 1)
        self.gridLayout.addWidget(self.checkboxes[5], 3, 2, 1, 1)
        self.gridLayout.addWidget(self.checkboxes[6], 4, 0, 1, 1)
        self.gridLayout.addWidget(self.checkboxes[7], 4, 1, 1, 1)
        self.gridLayout.addWidget(self.checkboxes[8], 4, 2, 1, 1)
